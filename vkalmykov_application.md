...
- Эффективность будильника основывается на анализе времени сна пользователя в течение длительного времени, что не подходит многим пользователям, которые не могут придерживаться стабильного режима из-за внешних обстоятельств или решившим проснуться раньше, чем обычно
- Не вознаграждается подъем вовремя
- Наличие легко активируемой функции "дай поспать", откладывающей время подъема на ~10 минут, (в которые возможна только быстрая фаза сна), что, согласно некоторым исследованияим, сказывается на работоспособности, вечернем засыпании и негативно влияет на здоровье
- Пользователь с легкостью может отключить будильник даже во сне
- Можно положить телефон на расстоянии от кровати, но ходьба - более инстинктивное действие, и пользователь может в полусне лечь обратно, в то время как выполнение описанных ниже заданий - более осознанная умственная деятельность, для которой необходим более высокий высокий уровень бодрости, а потому надежность данного решения эффективнее
...
- Анализ сна пользователя (например, длительность, наличие связанных со сном заболеваний, стабильность режима сна) и предложение оптимального времени подъема и засыпания
...
- Социальные элементы (возможность добавления в друзья и рейтинговая таблица для них) - пользователи смогут отслеживать скорость пробуждения и сравнивать свои результаты с друзьями, что также придаст им мотивации, как, например, это делается в трекерах ходьбы с подобными соц. элементами
...
- Alarmy: неудачный баланс сложности мини-игр, из-за которого пользователю легче просто удалить приложение; слишком активное потребление батареи; приложение часто не выполняет свои функции при сворачивании
